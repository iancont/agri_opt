...
La resolución iterativa del problema de optimización para diferentes niveles de riesgo genera el conjunto de portafolios que conforman la frontera eficiente, representada en la gráfica por la curva amarilla. Esta curva ilustra la relación fundamental entre riesgo y rendimiento en el contexto de la diversificación agrícola, donde cada punto representa una combinación óptima de cultivos para un nivel específico de riesgo.
...
El portafolio óptimo identificado mediante la optimización de Markowitz exhibe una distribución significativa en cuatro cultivos principales: Auyama (34.2%), Yautía (29.0%), Guineo (28.4%) y Aguacate (6.1%), con el restante 2.3% distribuido entre otros rubros. Esta composición refleja una estrategia sofisticada de optimización que equilibra la maximización del retorno esperado con la gestión efectiva del riesgo mediante diversificación.
